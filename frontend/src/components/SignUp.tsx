...
const SignUp = () => {
  ...
  const [_addressLine1, setAddressLine1] = useState<string>('');
  const [_addressLine2, setAddressLine2] = useState<string>('');
  const [_city, setCity] = useState<string>('');
  const [_state, setState] = useState<string>('');
  const [_postalCode, setPostalCode] = useState<string>('');
  const [_telephone, setTelephone] = useState<string>('');
